...
class Invoice:
    ...
    def get_invoice_total(self):
        ...
        for invoice_item in self.invoice_items:
            self.invoice_total += invoice_item.quantity * invoice_Product.cost
    ...
    def print_invoice(self):
        ...
        print('Customer name: ', Customer.first,' ', Customer.last)
        ...
        for invoice_item in self.invoice_items:
            ...
            print(invoice_item.get_name(), format(invoice_item.quantity, '12d'), \
                  format(invoice_Product.cost, '9,.2f'), format(invoice_item.get_extended_cost(), '13,.2f'))
